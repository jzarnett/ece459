...
\author{Patrick Lam}
\date{January 8, 2016 (Due: January 25, 2016*)}

\begin{document}

\maketitle

\textbf{Note: Due date updated to 25 January.}
...
\noindent and then clone the provided files. %(You can also download the provided
%files at \url{http://patricklam.ca/p4p/files/provided_a01.tar.gz}, but
%don't do that if you're in the course---it'll make submitting harder.)
