...
Once the sequential version is written, you will apply OpenMP directive. It's recommended to add them one at a time, or a related group at a time, to see what works and what doesn't. 
