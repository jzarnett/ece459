...
\paragraph{Rust vs... } Now that you know all about Rust, you can see a discussion of the \CPP~equivalents here: \url{https://reberhardt.com/cs110l/spring-2020/slides/lecture-18.pdf#page=27}. Basically everything in Rust also exists in \CPP, but \CPP~doesn't make you use these things in a safe way.
...
DTrace runs on Solaris and some BSDs. There is a Linux port, which should be installed
on the \texttt{ecetesla} and \texttt{eceubuntu} machines.
