...
Little's Law is a famous result, saying that the average number of jobs in the system equals the product of the average arrival rate into the system and the average arrival time in the system. The source on this section is~\cite{pmd}. 
...
where $E[N]$ is the expected value of the number of jobs in the system, $\lambda$ is the average arrival rate into the system, and $E[T]$ is the mean time jobs spend in the system. The basic setup of Little's Law looks something like this~\cite{pmd}:
