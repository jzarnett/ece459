...
\lecture{18 --- Mostly Data Parallelism}{\term}{Patrick Lam}
...
Data alignment, however, can be an issue. According to~\cite{sse}: ``Data must be 16-byte aligned when loading to and storing from the 128-bit XMM registers used by SSE/SSE2/SSE3/SSSE3. This must be done to avoid severe performance penalties.''. That's a pretty harsh restriction. SSE4.2 lifts it, if you know your machine is new enough.
...
The core of the (\CPP) implementation uses three SIMD instructions:
\begin{lstlisting}[language=C]
