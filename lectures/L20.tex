...
to the calling {\tt bar()} before returning to its caller, because
{\tt bar()} is done anyway. This avoids
...
\noindent
Good to use on your local machine, not ideal for code that you're shipping to client
machines, works fine on the cloud.
