...
There are four distributions we want to discuss: Bernoulli, Binomial, Geometric, and Poisson. The Poisson distribution is the one to focus on, but let's not overlook anything important.
...
%One more thing: there are also continuous random variables, and although we won't talk much about them, we should also consider the exponential distribution. 
