...
\frametitle{Grid Guidance}
 ...
 Then you have to adjust the grid size: divide the number of points by the threads per block to give the number of grids.
...
I did have to add a +1 to the number of grids, because 100~000 does not divide evenly by 256.
