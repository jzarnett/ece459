...
\lecture{30 --- Performance and Scalability}{\term}{Jeff Zarnett}
...
If we're not doing significant swapping, then memory isn't holding us back, so we can conclude it is not the limiting factor in scaling the application up.
