...
\begin{frame}[fragile]
  ...
  \alert{Joinable} threads (the default) wait for someone to call
  {\tt pthread\_join} before they release their resources.
  \vfill
   \alert{Detached} threads release resources when they terminate, without
  being joined.
  \vfill
  \begin{lstlisting}[language=C]
int pthread_detach(pthread_t thread);
  \end{lstlisting}
  \vfill
  {\tt thread}: marks the thread as detached
  \vfill
...
\begin{frame}[fragile]
\frametitle{One Ping Only, Please}
