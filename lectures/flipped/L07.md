...
// if probe_array[i] can be accessed with a much smaller time
// than accessing other probe_array[j], then data = i/4096;
```
...
other thread is doing by noticing its cache accesses and by timing how long it
takes to complete operations.
