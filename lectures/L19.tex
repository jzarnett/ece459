...
Even this example leverages some parallelism in the form of vector instructions. But there
are some sequential improvements. For instance, Stream VByte takes care to be a predictable
workload for the branch predictor.
...
and 1 if more bits remain. (UTF-8 does something similar, but with a different
representation.)
...
$0xf823~e127~2524~9748~1b..~....~....~....$. The 128-bit output is
$0x00f8~23e1/0000~0027/2524 9748/0000/001b$. The shuffle mask is precomputed and, at
...
its location is super predictable;
\item data bytes are sequential and loaded with high throughput;
\item shuffling takes 1 cycle;
