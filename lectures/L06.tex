...
To compile a C or \CPP program
with pthreads, add the {\tt -pthread} parameter to the compiler
commandline. If you want C99 for C, add \texttt{-std=c99}. To ensure \CPP11 support in GCC, use \verb!-std=C++11!.
...
\paragraph{Catch You Later...}Joinable threads
